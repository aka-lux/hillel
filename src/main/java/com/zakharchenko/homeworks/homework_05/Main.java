...
public class Main {
    public static void main(String[] args) {
        ...
        OrderMutable orderMutable = new OrderMutable(1, newDate, "0XBCA-DC72D", "Ukraine, Odessa");
        OrderMutable orderMutableTwo = new OrderMutable(1, newDate, "0XBCA-DC72D", "Ukraine, Odessa");
        System.out.println(orderMutable);
        newDate.setYear(1010);
        System.out.println(orderMutable);
        System.out.println(orderMutable == orderMutableTwo);

        OrderImmutable orderImmutable = new OrderImmutable(2, newDate1, "0XCCA-DD72D", "Ukraine, Lviv");
        OrderImmutable orderImmutableTwo = new OrderImmutable(2, newDate1, "0XCCA-DD72D", "Ukraine, Lviv");
